...
class MainActivity : ComponentActivity() {
    ...
    private fun buildApp(): View {
        ...
        if (isTablet()) {
            ...
            body.addView(ScrollView(this).apply { addView(content) }, LinearLayout.LayoutParams(0, -1, 1f))
    ...
    private fun showPage(index: Int) {
        ...
        val messages = listOf(
            "Aplicaciones Android desde ARR. La navegación permanece visible mientras cambia el contenido.",
